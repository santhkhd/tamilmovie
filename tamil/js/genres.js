...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const els = {
    ...
    backToGenres: document.getElementById("backToGenresBtn"),
  };
  ...
  const init = async () => {
    ...
    if (els.backToGenres) {
      els.backToGenres.addEventListener("click", () => {
        state.selectedGenre = null;
        showGenresView();
        renderGenres();
        window.history.pushState({}, "", "genres.html");
      });
    }
  ...
  const showGenresView = () => {
    ...
    els.moviesGrid.style.display = "none";
    if (els.backToGenres) {
      els.backToGenres.style.display = "none";
    }
  };
  ...
  const showMoviesView = () => {
    ...
    if (els.backToGenres) {
      els.backToGenres.style.display = "inline-flex";
    }
  };

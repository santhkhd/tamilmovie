...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateSortDirectionIcon = () => {
    const ascPath = els.sortDirectionBtn.querySelector(".asc-path");
    const descPath = els.sortDirectionBtn.querySelector(".desc-path");
    
    if (state.sortDirection === "asc") {
      els.sortDirectionBtn.setAttribute("aria-label", "Sort ascending");
      els.sortDirectionBtn.classList.remove("desc");
      els.sortDirectionBtn.classList.add("asc");
      ascPath.style.display = "block";
      descPath.style.display = "none";
    } else {
      els.sortDirectionBtn.setAttribute("aria-label", "Sort descending");
      els.sortDirectionBtn.classList.remove("asc");
      els.sortDirectionBtn.classList.add("desc");
      ascPath.style.display = "none";
      descPath.style.display = "block";
    }
  };
